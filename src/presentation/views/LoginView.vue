      ...
      <div class="max-w-[480px] w-full">
        <a href="javascript:void(0)"
          ><img
            ...
            alt="logo"
            class="w-40 mb-8 mx-auto block rounded-md"
          />
        </a>

        <div class="p-6 sm:p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
          <h1 class="text-slate-900 text-center text-3xl font-semibold">Inicio de Sesión</h1>
          <form class="mt-12 space-y-6" @submit.prevent="handleLogin">
            <div>
              <label class="text-slate-900 text-sm font-medium mb-2 block">Usuario</label>
            ...
            <div>
              <label class="text-slate-900 text-sm font-medium mb-2 block">Contraseña</label>
              <div class="relative flex items-center">
                <input
                  name="password"
                  type="password"
