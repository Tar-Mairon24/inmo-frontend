<template>
  <div class="relative mb-8 group">
    ...
    <div
      v-if="images.length > 1"
      class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 bg-black bg-opacity-0 hover:bg-opacity-50 text-white opacity-0 group-hover:opacity-100 transition-all duration-300"
    >
      <button
...
const images = ref([placeholderImage, placeholderImage, placeholderImage, placeholderImage])
